...
public class LowerArmSlider : MonoBehaviour {
	...
	public Transform RobotBase;//whole robot
	public Transform RobotLowerArm;//robot without base
	
	public Transform joint0, joint1, joint2;//base rotataion, lower rotation, upper rotation
